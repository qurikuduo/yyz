...
const zh: Dict = {
  ...
  'home.intro':
    '本工具基于国际主流的权威抑郁量表，可单独使用某个量表，也可（后续）进行综合评估。结果含逐题解释与答案解析，仅供参考，非临床诊断。',
  'home.items': '题',
  'home.start': '开始',
...
const en: Dict = {
  ...
  'home.intro':
    'This tool is built on internationally recognized, authoritative depression scales. Use a single scale, or (coming soon) a comprehensive multi-scale synthesis. Results include per-item explanations and answer analysis, for reference only — not a clinical diagnosis.',
  'home.items': 'items',
  'home.start': 'Start',
